...
% $Revision: 1.1.6.19 $  $Date: 2013/05/13 23:10:13 $
...
function net = formatNet(net)
  if isempty(net.performFcn)
    warning('nnet:trainc:Performance',nnwarning.empty_performfcn_corrected);
    net.performFcn = 'mse';
  end
end
...
function [net,tr] = train_network(net,tr,data,fcns,param)
  ...
  for epoch=0:param.epochs
    ...
    nnet.train.feedback('update',net,tr,[],status,data,statusValues);

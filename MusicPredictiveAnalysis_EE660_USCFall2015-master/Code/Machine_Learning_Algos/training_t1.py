...
#PREPROCESSING
#Read the files
df_full = pd.read_pickle("/Users/ahmetcanozbek/Desktop/660Stuff/msd_train_t1.pkl")   # 80%
...
# # predicted = clf.predict(X_cropped)
...
# print "Error Rate on kNNC (t1):  ", ml_aux.get_error_rate(y_validation, y_validation_predicted)
...
# print "Error Rate: ", ml_aux.get_error_rate(y_validation, y_validation_predicted)

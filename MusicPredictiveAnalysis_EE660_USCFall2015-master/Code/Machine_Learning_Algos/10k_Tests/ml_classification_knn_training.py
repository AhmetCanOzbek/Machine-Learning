...
if __name__ == '__main__':
    ...
    # k-Nearest Neighbors
    knn1 = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    knn1.fit(df_input1_data,numpy.ravel(df_input1_target))
    pickle.dump(knn1, open('model_kNearestNeighbor_t1.pkl', 'wb'))

    knn2 = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    knn2.fit(df_input2_data,numpy.ravel(df_input2_target))
    pickle.dump(knn2, open('model_kNearestNeighbor_t2.pkl', 'wb'))

    knn3 = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    knn3.fit(df_input3_data,numpy.ravel(df_input3_target))
    pickle.dump(knn3, open('model_kNearestNeighbor_t3.pkl', 'wb'))

    knn4 = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    knn4.fit(df_input4_data,numpy.ravel(df_input4_target))
    pickle.dump(knn4, open('model_kNearestNeighbor_t4.pkl', 'wb'))

    knn5 = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    knn5.fit(df_input5_data,numpy.ravel(df_input5_target))
    pickle.dump(knn5, open('model_kNearestNeighbor_t5.pkl', 'wb'))

    # knn = neighbors.KNeighborsClassifier(n_neighbors=2, algorithm='auto', leaf_size=50)
    # knn.fit(df_input_data,numpy.ravel(df_input_target))
    # pickle.dump(knn, open('model_kNearestNeighbor_train.pkl', 'wb'))

    predicted1 = knn1.predict(df_input1_data)
    predicted2 = knn2.predict(df_input2_data)
    predicted3 = knn3.predict(df_input3_data)
    predicted4 = knn4.predict(df_input4_data)
    predicted5 = knn5.predict(df_input5_data)
    # predicted = knn.predict(df_input_data)
    ...
    predicted1 = knn1.predict(x_df_input1_data)
    predicted2 = knn2.predict(x_df_input2_data)
    predicted3 = knn3.predict(x_df_input3_data)
    predicted4 = knn4.predict(x_df_input4_data)
    predicted5 = knn5.predict(x_df_input5_data)
    # predicted = knn.predict(x_df_input_data)
